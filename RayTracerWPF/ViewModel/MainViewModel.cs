...
namespace RayTracerWPF.ViewModel
{
    ...
    public class MainViewModel /*: ViewModelBase*/
    {
        ...
        public MainViewModel(IDataService dataService)
        {
            ...
            _spheresXX.Add( new Model.RayTracerViewModel { RadiusXXXX = 50.0, CenterX = 200.0, CenterY = 300.0, CenterZ = 0.0, Color = "xxx" });
        }
        ...
        private ObservableCollection<Model.RayTracerViewModel> _spheresXX = new ObservableCollection<Model.RayTracerViewModel>();
        public ObservableCollection<Model.RayTracerViewModel> SpheresXX
        {
            get => _spheresXX;
