...
namespace RayTracerLib
{
    public class RayTracer : IRaTracer
    {
        ...
        private void InitializeDefaultData()
        {
            ...
            lv = new Vector(1.0, 1.0, -0.5);
            p = new Vector(100.0, 100.0, 500.0);
            ...
            objects.Add(new Sphere(200.0, 100.0, 0.0, 40.0, new Color(0.0, 0.0, 255.0)));
            objects.Add(new Sphere(300.0, 150.0, -50.0, 60.0, new Color(255.0, 0.0, 255.0)));
            objects.Add(new Sphere(100.0, 100.0, 180.0, 60.0, new Color(255.0, 0.0, 255.0)));
            Vector v0 = new Vector(100.0, 100.0, 0.0);
            Vector v1 = new Vector(100.0, 80.0, 0.0);
            Vector v2 = new Vector(80.0, 100.0, 0.0);
            Triangle t = new Triangle(v0, v1, v2, new Color(255.0, 0.0, 0.0));
            objects.Add(t);
            v0 = new Vector(200.0, 200.0, 0.0);
            v1 = new Vector(200.0, 280.0, 0.0);
            v2 = new Vector(280.0, 300.0, 0.0);
            t = new Triangle(v0, v1, v2, new Color(0.0, 255.0, 0.0));
            objects.Add(t);
        }
